...
namespace TrueCentralVms.Drivers.Hikvision.Interop
{
    ...
    public class CHCNetSDK
    {
        ...
        **************************************************/
        ...
        {
            public byte byEnable;
            [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 240)]
            public string strURL;/* 取流URL路径 */
        ...
        public struct NET_DVR_DEV_CHAN_INFO_EX
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
            // byte[] y no ByValTStr: ByValTStr reserva el 鷏timo byte para el nulo
            // y deja 15 caracteres 鷗iles; el SDK admite PASSWD_LEN (16) completos.
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] sUserName;  	        //监控主机登陆帐号
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = PASSWD_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] sPassword;  	        //监控主机密码
